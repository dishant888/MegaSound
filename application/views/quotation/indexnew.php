                                                            ...
                                                            <div> 
                                                                <div id="step-1" class="container-fluid">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <!--        <select required class="form-control select2" name="cost">-->
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <input type="text" name="event[0][event_venue]" id="event_venue" placeholder="Venue Name" class="form-control event_venue" required>
                                                                                        </div>
                                                                                </div>
                                                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                                                        <div class="form-group">
                                                                                            <label>Event Function</label>
                                                                                            <input type="text" name="event[0][event_function]" id="event_function" placeholder="Function Name" class="form-control event_function" required>
                                                                                        </div>
                                                                                </div>
                                                                                <div class="col-lg-4 col-md-4 col-sm-6">
                                                                                        <div class="form-group">
                                                                                            <label>Event Artist</label>
                                                                                            <input type="text" name="event[0][event_artist]" id="event_artist" placeholder="Artist Name" class="form-control event_artist" required>
                                                                                        </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div id="step-2" class="">
                                                                    <table class="table">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="5">
                                                                                    <textarea style="height: 220px;" name="footer_content" class="form-control" id="footer_content_ck"></textarea>
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="5">
                                                                                    <textarea style="height: 220px;" name="footer_service" class="form-control" id="footer_service_ck"></textarea>
                                                                                </td>
                                                                            </tr>
                                                                             <tr>
                                                                                <td colspan="">
