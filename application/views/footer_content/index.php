...
<h3 class="m-b-10">Quotation Footer Content</h3>
</div>
<div class="row">
...
<div class="row">
    ...
    <div class="col-sm-12">
        <?php echo form_open('master/addFooterContent'); ?>
...
<div class="col-sm-12">
    <table class="table table-striped" id="venue">
        ...
        <tbody>
            <?php $i=0; foreach($contents as $genset): ?>
                <tr>
                    <td><?=++$i?></td>
                    <td><?=wordwrap($genset['description'],50,'<br>',true)?></td>
                    <td align="center">
                        <a href="<?=base_url('master/deleteFooterContent/')?><?=base64_encode($genset['id'])?>" onclick="return confirm('Are you sure?')" data-toggle="tooltip" data-placement="top" class="text-danger" data-original-title="Delete"><i class='fas fa-times'></i></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
